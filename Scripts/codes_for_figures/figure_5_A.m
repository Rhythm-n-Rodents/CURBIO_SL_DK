...
%% To run the code
% 1. Edit Line #115. Edit the path to the "Data" folder.
...
%SUBJECT = ["SLR114", "h", "SM", 36, 4];    
%SUBJECT = ["SLR124", "h", "CM", 36, 3];
%SUBJECT = ["SLR123", "h", "CT", 36, 4];
%SUBJECT = ["SLR124", "h", "SP", 36, 4];
%SUBJECT = ["SLR124", "h", "BC", 36, 5];
